...
namespace KztekObject.Controllers.KZE32NET_v3._6_Controller
{
    public class KZE32_NET_v3_6 : abstract_KZTEK_Controller
    {
        #region: PROPERTIES
        ...
        public override bool DownloadUser(Employee employee)
        {
            ...
            string door = KzHelper.GetOpenDoor(employee.Doors, KzHelper.EM_ByteLength._8BYTE);
            if (door == "")
            {
                return false;
            }
        ...
        public override bool OpenMultyDoor(List<int> relayIndexs)
        {
            ...
            string SetArrayRelayCMD = KZTEK_CMD.OpenArrayRelayCMD(relayIndexs);
            string response = SocketTools.ExecuteCommand(comport, baudrate, null, SetArrayRelayCMD, ref viewraw, ref message, 500, SocketTools.STX, Encoding.ASCII);
            //Char(2) + SetArrRelay?/OK + char(3) 
            //Char(2) + SetArrRelay?/ERR + char(3)
